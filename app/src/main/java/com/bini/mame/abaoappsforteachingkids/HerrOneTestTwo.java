 ...
 */
public class HerrOneTestTwo extends AppCompatActivity
{
    private Button ques;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.herr_one_ques_two);

        // variable initialization

        ques = (Button) findViewById(R.id.mk2);
        group = (RadioGroup) findViewById(R.id.mgp2);
        rba = (RadioButton) findViewById(R.id.mka2);
        rbb = (RadioButton) findViewById(R.id.mkb2);
        rbc = (RadioButton) findViewById(R.id.mkc2);
        next = (Button) findViewById(R.id.mkn2);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (list.size() == question.length){
                    ...
                    HerrOneDatabaseTwo bini = new HerrOneDatabaseTwo(cxt2);
                    bini.saveMaths1(bini, NAMES, MARKS, DATE);
                    Toast.makeText(getApplicationContext(), "BAGA GAMMADDE HAALA GAARIIN QABXIIN KEE KUUFAMEERA", Toast.LENGTH_LONG).show();
                    finish();
                }
                if (list.size() >= question.length) {
                    Intent intent = new Intent(HerrOneTestTwo.this, HerrOneCorrectionTwo.class);
