 ...
 */
public class DubbachAaa extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dubb_aaa);

        vee = (ImageView) findViewById(R.id.duba);
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                finish();
                Intent intent = new Intent(getApplicationContext(), DubbachEee.class);
