 ...
 */
public class AfanOneDragAndDropOne extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.drag_afan_one);
        ...
        a11 = (Button) findViewById(R.id.nm1);
        b11 = (Button) findViewById(R.id.nm2);
        c11 = (Button) findViewById(R.id.nm3);
        d11 = (Button) findViewById(R.id.nm4);
        e11 = (Button) findViewById(R.id.nm5);
        f11 = (Button) findViewById(R.id.nm6);
        g11 = (Button) findViewById(R.id.nm7);
        h11 = (Button) findViewById(R.id.nm8);
        ...
        b11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.b);
                bini.start();
            }
        });
        c11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.c);
                bini.start();
            }
        });
        d11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.d);
                bini.start();
            }
        });
        ...
        f11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.f);
                bini.start();
            }
        });
        g11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.g);
                bini.start();
            }
        });
        h11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.h);
                bini.start();
            }
        });
    }
