 ...
 */
public class HerrTwoResultOne extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    HerrTwoDatabaseOne herrTwoDatabaseOne;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.herr_two_username_one);
        users = (EditText) findViewById(R.id.maq26);
        see = (Button) findViewById(R.id.fun26);
        listView = (ListView) findViewById(R.id.listView26);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    herrTwoDatabaseOne = new HerrTwoDatabaseOne(getApplicationContext());
                    sqLiteDatabase = herrTwoDatabaseOne.getReadableDatabase();
                    Cursor cursor = herrTwoDatabaseOne.ShowHerrTwoResultOne(name, sqLiteDatabase );
