 ...
 */
public class EngOneResultTwo extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    EngOneDatabaseTwo engOneDatabaseTwo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eng_one_username_two);
        users = (EditText) findViewById(R.id.maq5);
        see = (Button) findViewById(R.id.fun5);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    engOneDatabaseTwo = new EngOneDatabaseTwo(getApplicationContext());
                    sqLiteDatabase = engOneDatabaseTwo.getReadableDatabase();
                    Cursor cursor = engOneDatabaseTwo.ShowEngResultTwo(name, sqLiteDatabase );
