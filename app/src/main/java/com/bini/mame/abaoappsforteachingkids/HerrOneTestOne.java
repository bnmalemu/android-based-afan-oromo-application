 ...
 */
public class HerrOneTestOne extends AppCompatActivity
{
    private Button ques;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.herr_one_ques_one);

        // variable initialization

        ques = (Button) findViewById(R.id.mk1);
        group = (RadioGroup) findViewById(R.id.mgp1);
        rba = (RadioButton) findViewById(R.id.mka1);
        rbb = (RadioButton) findViewById(R.id.mkb1);
        rbc = (RadioButton) findViewById(R.id.mkc1);
        next = (Button) findViewById(R.id.mkn1);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (list.size() == question.length){
                    ...
                    HerrOneDatabaseOne bini = new HerrOneDatabaseOne(cxt1);
                    bini.saveMaths(bini, NAMES, MARKS, DATE);
                    Toast.makeText(getApplicationContext(), "BAGA GAMMADDE HAALA GAARIIN QABXIIN KEE KUUFAMEERA", Toast.LENGTH_LONG).show();
                    finish();
                }
                if (list.size() >= question.length) {
                    Intent bini1 = new Intent(HerrOneTestOne.this, HerrOneCorrectionOne.class);
                    startActivity(bini1);
                }
            }
        });
