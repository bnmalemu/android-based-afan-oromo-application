 ...
 */
public class HerrThreeResultOne extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    HerrThreeDatabaseOne herrThreeDatabaseOne;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.herr_three_username_one);
        users = (EditText) findViewById(R.id.maq16);
        see = (Button) findViewById(R.id.fun16);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    herrThreeDatabaseOne = new HerrThreeDatabaseOne(getApplicationContext());
                    sqLiteDatabase = herrThreeDatabaseOne.getReadableDatabase();
                    Cursor cursor = herrThreeDatabaseOne.ShowHerrThreeResultOne(name, sqLiteDatabase );
