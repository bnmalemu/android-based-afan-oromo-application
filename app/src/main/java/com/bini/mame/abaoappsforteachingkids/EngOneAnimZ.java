 ...
 */
public class EngOneAnimZ extends AppCompatActivity
{
    ImageView zed;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bbbbz);

        zed = (ImageView) findViewById(R.id.bbz);
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                rihana = MediaPlayer.create(getApplicationContext(), R.raw.zz);
                rihana.start();
            }
