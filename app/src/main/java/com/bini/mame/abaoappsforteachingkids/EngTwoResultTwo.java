 ...
 */
public class EngTwoResultTwo extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    EngTwoDatabaseTwo engTwoDatabaseTwo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eng_two_username_two);
        users = (EditText) findViewById(R.id.maq8);
        see = (Button) findViewById(R.id.fun8);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    engTwoDatabaseTwo = new EngTwoDatabaseTwo(getApplicationContext());
                    sqLiteDatabase = engTwoDatabaseTwo.getReadableDatabase();
                    Cursor cursor = engTwoDatabaseTwo.ShowEngTwoResultTwo(name, sqLiteDatabase);
