 ...
 */
public class CourseOne extends TabActivity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tab1.setContent(new Intent(this, AfanOromoOne.class));

        tab2.setIndicator("HERREGA");
        tab2.setContent(new Intent(this, HeregaOne.class));

        tab3.setIndicator("INGILIFFA");
        tab3.setContent(new Intent(this, EnglishOne.class));
