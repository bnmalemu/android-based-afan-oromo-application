 ...
 */
public class DubbachEee extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dubb_eee);

        vee = (ImageView) findViewById(R.id.dube);
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                finish();
                Intent intent = new Intent(getApplicationContext(), DubbachIii.class);
