 ...
 */
public class HerrThreeDragAndDropOne extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.herr_three_drag_one);
        a = (TextView) findViewById(R.id.chy);
        b = (TextView) findViewById(R.id.dhy);
        c = (TextView) findViewById(R.id.nyy);
        d = (TextView) findViewById(R.id.phy);
        e = (TextView) findViewById(R.id.shy);
        f = (TextView) findViewById(R.id.tsy);

        a11 = (Button) findViewById(R.id.jar11);
        b11 = (Button) findViewById(R.id.jar21);
        c11 = (Button) findViewById(R.id.jar31);
        d11 = (Button) findViewById(R.id.jar41);
        e11 = (Button) findViewById(R.id.jar51);
        f11 = (Button) findViewById(R.id.jar61);
        ...
        a11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.dhishan);
                bini.start();
            }
        });
        b11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.sadtorba);
                bini.start();
            }
        });
        c11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.sasagal);
                bini.start();
            }
        });
        d11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.tosagal);
                bini.start();
            }
        });
        e11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.dhibbatokko);
                bini.start();
            }
        });
        f11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.salama);
                bini.start();
            }
        });
    }
