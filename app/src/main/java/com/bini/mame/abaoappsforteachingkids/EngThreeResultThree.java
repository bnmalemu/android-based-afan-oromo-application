 ...
 */
public class EngThreeResultThree extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    EngThreeDatabaseThree engThreeDatabaseThree;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eng_three_username_three);
        users = (EditText) findViewById(R.id.maq12);
        see = (Button) findViewById(R.id.fun12);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    engThreeDatabaseThree = new EngThreeDatabaseThree(getApplicationContext());
                    sqLiteDatabase = engThreeDatabaseThree.getReadableDatabase();
                    Cursor cursor = engThreeDatabaseThree.ShowEngThreeResultThree(name, sqLiteDatabase );
