 ...
 */
public class EngThreeResultOne extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    EngThreeDatabaseOne engThreeDatabaseOne;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eng_three_username_one);
        users = (EditText) findViewById(R.id.maq10);
        see = (Button) findViewById(R.id.fun10);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    engThreeDatabaseOne = new EngThreeDatabaseOne(getApplicationContext());
                    sqLiteDatabase = engThreeDatabaseOne.getReadableDatabase();
                    Cursor cursor = engThreeDatabaseOne.ShowEngThreeResultOne(name, sqLiteDatabase );
