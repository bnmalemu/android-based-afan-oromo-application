 ...
 */
public class HerrOneDragAndDropThree extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.drag_herr_three);
        a = (TextView) findViewById(R.id.chq);
        b = (TextView) findViewById(R.id.dhq);
        c = (TextView) findViewById(R.id.nyq);
        d = (TextView) findViewById(R.id.phq);
        e = (TextView) findViewById(R.id.shq);
        f = (TextView) findViewById(R.id.tsq);

        a11 = (Button) findViewById(R.id.jarq11);
        b11 = (Button) findViewById(R.id.jarq21);
        c11 = (Button) findViewById(R.id.jarq31);
        d11 = (Button) findViewById(R.id.jarq41);
        e11 = (Button) findViewById(R.id.jarq51);
        f11 = (Button) findViewById(R.id.jarq61);
        ...
        a11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.aftokko);
                bini.start();
            }
        });
        b11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.soafur);
                bini.start();
            }
        });
        c11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.ditorba);
                bini.start();
            }
        });
        d11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.kusadet);
                bini.start();
            }
        });
        e11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.afjaa);
                bini.start();
            }
        });
        f11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.kusadi);
                bini.start();
            }
        });
    }
