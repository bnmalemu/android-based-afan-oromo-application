 ...
 */
public class AfanOneAnimR extends AppCompatActivity
{
    ImageView rrr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aaaar);

        rrr = (ImageView) findViewById(R.id.aar);
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                finish();
                Intent intent = new Intent(getApplicationContext(), AfanOneAnimS.class);
