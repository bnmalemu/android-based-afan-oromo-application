...
/**
 * Created by Mame on 5/16/2016.
 */
public class AfanOneDragAndDropThree extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.drag_afan_one_three);

        q = (TextView) findViewById(R.id.q1);
        r = (TextView) findViewById(R.id.r1);
        s = (TextView) findViewById(R.id.s1);
        t = (TextView) findViewById(R.id.t1);
        u = (TextView) findViewById(R.id.u1);
        vv = (TextView) findViewById(R.id.v1);
        w = (TextView) findViewById(R.id.w1);
        x = (TextView) findViewById(R.id.x1);
        y = (TextView) findViewById(R.id.y1);
        z = (TextView) findViewById(R.id.z1);

        q11 = (Button) findViewById(R.id.nm17);
        r11 = (Button) findViewById(R.id.nm18);
        s11 = (Button) findViewById(R.id.nm19);
        t11 = (Button) findViewById(R.id.nm20);
        u11 = (Button) findViewById(R.id.nm21);
        v11 = (Button) findViewById(R.id.nm22);
        w11 = (Button) findViewById(R.id.nm23);
        x11 = (Button) findViewById(R.id.nm24);
        y11 = (Button) findViewById(R.id.nm25);
        z11 = (Button) findViewById(R.id.nm26);
        ...
        q11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.q);
                mame.start();
            }
        });
        r11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.r);
                mame.start();
            }
        });
        s11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.s);
                mame.start();
            }
        });
        t11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.t);
                mame.start();
            }
        });
        u11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.u);
                mame.start();
            }
        });
        v11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.v);
                mame.start();
            }
        });
        w11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.w);
                mame.start();
            }
        });
        x11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.x);
                mame.start();
            }
        });
        y11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.y);
                mame.start();
            }
        });
        z11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.z);
                mame.start();
            }
        });
    }
