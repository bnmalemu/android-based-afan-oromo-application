 ...
 */
public class EngTwoResultThree extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    EngTwoDatabaseThree engTwoDatabaseThree;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eng_two_username_three);
        users = (EditText) findViewById(R.id.maq9);
        see = (Button) findViewById(R.id.fun9);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    engTwoDatabaseThree = new EngTwoDatabaseThree(getApplicationContext());
                    sqLiteDatabase = engTwoDatabaseThree.getReadableDatabase();
                    Cursor cursor = engTwoDatabaseThree.ShowEngTwoResultThree(name, sqLiteDatabase);
