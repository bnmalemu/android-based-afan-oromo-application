 ...
 */
public class AfanTwoResultThree extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    AfanTwoDatabaseThree afanTwoDatabaseThree;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.afan_two_username_three);
        users = (EditText) findViewById(R.id.maq22);
        see = (Button) findViewById(R.id.fun22);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    afanTwoDatabaseThree = new AfanTwoDatabaseThree(getApplicationContext());
                    sqLiteDatabase = afanTwoDatabaseThree.getReadableDatabase();
                    Cursor cursor = afanTwoDatabaseThree.ShowAfanTwoResultThree(name, sqLiteDatabase);
