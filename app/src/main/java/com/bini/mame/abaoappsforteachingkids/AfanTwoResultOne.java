 ...
 */
public class AfanTwoResultOne extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    AfanTwoDatabaseOne afanTwoDatabaseOne;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.afan_two_username_one);
        users = (EditText) findViewById(R.id.maq20);
        see = (Button) findViewById(R.id.fun20);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    afanTwoDatabaseOne = new AfanTwoDatabaseOne(getApplicationContext());
                    sqLiteDatabase = afanTwoDatabaseOne.getReadableDatabase();
                    Cursor cursor = afanTwoDatabaseOne.ShowAfanTwoResultOne(name, sqLiteDatabase);
