 ...
 */
public class EngOneDragAndDropTwo extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.drag_eng_two);
        i = (TextView) findViewById(R.id.ii1);
        j = (TextView) findViewById(R.id.ji1);
        k = (TextView) findViewById(R.id.ki1);
        l = (TextView) findViewById(R.id.li1);
        m = (TextView) findViewById(R.id.mi1);
        n = (TextView) findViewById(R.id.ni1);
        o = (TextView) findViewById(R.id.oi1);
        p = (TextView) findViewById(R.id.pi1);

        i11 = (Button) findViewById(R.id.nmi9);
        j11 = (Button) findViewById(R.id.nmi10);
        k11 = (Button) findViewById(R.id.nmi11);
        l11 = (Button) findViewById(R.id.nmi12);
        m11 = (Button) findViewById(R.id.nmi13);
        n11 = (Button) findViewById(R.id.nmi14);
        o11 = (Button) findViewById(R.id.nmi15);
        p11 = (Button) findViewById(R.id.nmi16);
        ...
        i11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.ii);
                mame.start();
            }
        });
        j11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.jj);
                mame.start();
            }
        });
        k11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.kk);
                mame.start();
            }
        });
        l11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.ll);
                mame.start();
            }
        });
        m11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.mm);
                mame.start();
            }
        });
        n11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.nn);
                mame.start();
            }
        });
        o11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.oo);
                mame.start();
            }
        });
        p11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mame = MediaPlayer.create(getApplicationContext(), R.raw.pp);
                mame.start();
            }
        });
    }
