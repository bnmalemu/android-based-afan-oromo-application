 ...
 */
public class AfanTokoLessTwoAudio extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.afan_one_list_view_two);
        list = (ListView) findViewById(R.id.al1);
        list.setAdapter(new ArrayAdapter<>(this, R.layout.afan_one_single_row_less_two, R.id.aku1, small));
