 ...
 */
public class AfanThreeResultTwo extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    AfanThreeDatabaseTwo afanThreeDatabaseTwo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.afan_three_username_two);
        users = (EditText) findViewById(R.id.maq24);
        see = (Button) findViewById(R.id.fun24);
        listView = (ListView) findViewById(R.id.listView24);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    afanThreeDatabaseTwo = new AfanThreeDatabaseTwo(getApplicationContext());
                    sqLiteDatabase = afanThreeDatabaseTwo.getReadableDatabase();
                    Cursor cursor = afanThreeDatabaseTwo.ShowAfanThreeResultTwo(name, sqLiteDatabase);
