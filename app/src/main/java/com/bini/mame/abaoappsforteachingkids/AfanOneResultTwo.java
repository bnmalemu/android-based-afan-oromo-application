 ...
 */
public class AfanOneResultTwo extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    AfanOneDatabaseTwo afanOneDatabaseTwo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.afan_one_username_two);
        users = (EditText) findViewById(R.id.maq2);
        see = (Button) findViewById(R.id.fun2);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    afanOneDatabaseTwo = new AfanOneDatabaseTwo(getApplicationContext());
                    sqLiteDatabase = afanOneDatabaseTwo.getReadableDatabase();
                    Cursor cursor = afanOneDatabaseTwo.ShowAfanResultTwo(name, sqLiteDatabase );
