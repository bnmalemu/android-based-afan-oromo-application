 ...
 */
public class HerrThreeDragAndDropTwo extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.herr_three_drag_two);
        a = (TextView) findViewById(R.id.chg);
        b = (TextView) findViewById(R.id.dhg);
        c = (TextView) findViewById(R.id.nyg);
        d = (TextView) findViewById(R.id.phg);
        e = (TextView) findViewById(R.id.shg);
        f = (TextView) findViewById(R.id.tsg);

        a11 = (Button) findViewById(R.id.jar13);
        b11 = (Button) findViewById(R.id.jar23);
        c11 = (Button) findViewById(R.id.jar33);
        d11 = (Button) findViewById(R.id.jar43);
        e11 = (Button) findViewById(R.id.jar53);
        f11 = (Button) findViewById(R.id.jar63);
        ...
        a11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.toshan);
                bini.start();
            }
        });
        b11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.dhikudhan);
                bini.start();
            }
        });
        ...
        d11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.sadetama);
                bini.start();
            }
        });
        e11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.saafur);
                bini.start();
            }
        });
        f11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bini = MediaPlayer.create(getApplicationContext(), R.raw.dhidigdama);
                bini.start();
            }
        });
    }
