 ...
 */
public class HerrLamaLessTwoAddition extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        first = (EditText) findViewById(R.id.add1);
        second = (EditText) findViewById(R.id.add2);
        third = (EditText) findViewById(R.id.add3);
        number1 = (Button) findViewById(R.id.add5);
        number2 = (Button) findViewById(R.id.add6);
        result = (Button) findViewById(R.id.add4);
        clear = (Button) findViewById(R.id.add7);
