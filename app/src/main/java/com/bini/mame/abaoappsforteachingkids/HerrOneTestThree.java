 ...
 */
public class HerrOneTestThree extends AppCompatActivity
{
    private Button ques;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.herr_one_ques_three);

        // variable initialization

        ques = (Button) findViewById(R.id.mk3);
        group = (RadioGroup) findViewById(R.id.mgp3);
        rba = (RadioButton) findViewById(R.id.mka3);
        rbb = (RadioButton) findViewById(R.id.mkb3);
        rbc = (RadioButton) findViewById(R.id.mkc3);
        next = (Button) findViewById(R.id.mkn3);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (list.size() == question.length){
                    ...
                    HerrOneDatabaseThree bini = new HerrOneDatabaseThree(cxt1);
                    bini.saveMaths2(bini, NAMES, MARKS, DATE);
                    Toast.makeText(getApplicationContext(), "BAGA GAMMADDE HAALA GAARIIN QABXIIN KEE KUUFAMEERA", Toast.LENGTH_LONG).show();
                    finish();
                }
                if (list.size() >= question.length) {
                    Intent intent = new Intent(HerrOneTestThree.this, HerrOneCorrectionThree.class);
