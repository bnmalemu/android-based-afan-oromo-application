 ...
 */
public class EnglishTwo extends TabActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        tab1.setContent(new Intent(this, EngTwoLessOneAudio.class));

        tab2.setIndicator("2ST LESS");
        tab2.setContent(new Intent(this, EngTwoLessTwoAudio.class));

        tab3.setIndicator("3ST LESS");
        tab3.setContent(new Intent(this, EngTwoLessThreeAudio.class));

        tab4.setIndicator("4ST LESS");
        tab4.setContent(new Intent(this, EngTwoLessFourAudio.class));
