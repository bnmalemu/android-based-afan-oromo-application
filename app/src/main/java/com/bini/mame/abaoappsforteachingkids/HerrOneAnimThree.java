 ...
 */
public class HerrOneAnimThree extends AppCompatActivity
{
    ImageView bini;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bini = (ImageView) findViewById(R.id.ccc);
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                rihana = MediaPlayer.create(getApplicationContext(), R.raw.sadii);
                rihana.start();
            }
            ...
            public void onAnimationEnd(Animation animation) {
                finish();
                startActivity(new Intent(getApplicationContext(), HerrOneAnimFour.class));
