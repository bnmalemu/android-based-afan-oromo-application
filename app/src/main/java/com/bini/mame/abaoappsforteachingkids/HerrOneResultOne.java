 ...
 */
public class HerrOneResultOne extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    HerrOneDatabaseOne herrOneDatabaseOne;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.herr_one_username_one);
        users = (EditText) findViewById(R.id.maq13);
        see = (Button) findViewById(R.id.fun13);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    herrOneDatabaseOne = new HerrOneDatabaseOne(getApplicationContext());
                    sqLiteDatabase = herrOneDatabaseOne.getReadableDatabase();
                    Cursor cursor = herrOneDatabaseOne.ShowHerrResultOne(name, sqLiteDatabase );
