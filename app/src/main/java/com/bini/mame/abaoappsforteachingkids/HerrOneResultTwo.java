 ...
 */
public class HerrOneResultTwo extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    HerrOneDatabaseTwo herrOneDatabaseTwo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.herr_one_username_two);
        users = (EditText) findViewById(R.id.maq14);
        see = (Button) findViewById(R.id.fun14);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    herrOneDatabaseTwo = new HerrOneDatabaseTwo(getApplicationContext());
                    sqLiteDatabase = herrOneDatabaseTwo.getReadableDatabase();
                    Cursor cursor = herrOneDatabaseTwo.ShowHerrResultTwo(name, sqLiteDatabase );
