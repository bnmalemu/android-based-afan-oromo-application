 ...
 */
public class HerrOneAnimThirty extends AppCompatActivity
{
    ImageView bini;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bini = (ImageView) findViewById(R.id.ddd);
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                rihana = MediaPlayer.create(getApplicationContext(), R.raw.sodoma);
                rihana.start();
            }
            ...
            public void onAnimationEnd(Animation animation) {
                finish();
                startActivity(new Intent(getApplicationContext(), HerrOneAnimThirtyOne.class));
