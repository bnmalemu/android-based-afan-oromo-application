 ...
 */
public class HerrTwoResultTwo extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    HerrTwoDatabaseTwo herrTwoDatabaseTwo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.herr_two_username_two);
        users = (EditText) findViewById(R.id.maq27);
        see = (Button) findViewById(R.id.fun27);
        listView = (ListView) findViewById(R.id.listView27);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    herrTwoDatabaseTwo = new HerrTwoDatabaseTwo(getApplicationContext());
                    sqLiteDatabase = herrTwoDatabaseTwo.getReadableDatabase();
                    Cursor cursor = herrTwoDatabaseTwo.ShowHerrTwoResultTwo(name, sqLiteDatabase );
