 ...
 */
public class EngOneResultThree extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    EngOneDatabaseThree engOneDatabaseThree;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eng_one_username_three);
        users = (EditText) findViewById(R.id.maq6);
        see = (Button) findViewById(R.id.fun6);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    engOneDatabaseThree = new EngOneDatabaseThree(getApplicationContext());
                    sqLiteDatabase = engOneDatabaseThree.getReadableDatabase();
                    Cursor cursor = engOneDatabaseThree.ShowEngResultThree(name, sqLiteDatabase);
