 ...
 */
public class DubbachIii extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dubb_iii);

        vee = (ImageView) findViewById(R.id.dubi);
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                finish();
                Intent intent = new Intent(getApplicationContext(), DubbachOoo.class);
