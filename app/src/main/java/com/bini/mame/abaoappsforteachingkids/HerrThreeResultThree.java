 ...
 */
public class HerrThreeResultThree extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    HerrThreeDatabaseThree herrThreeDatabaseThree;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.herr_three_username_three);
        users = (EditText) findViewById(R.id.maq18);
        see = (Button) findViewById(R.id.fun18);
        listView = (ListView) findViewById(R.id.listView18);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    herrThreeDatabaseThree = new HerrThreeDatabaseThree(getApplicationContext());
                    sqLiteDatabase = herrThreeDatabaseThree.getReadableDatabase();
                    Cursor cursor = herrThreeDatabaseThree.ShowHerrThreeResultThree(name, sqLiteDatabase );
