 ...
 */
public class AfanOneResultOne extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    AfanOneDatabaseOne afanOneDatabaseOne;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.afan_one_username_one);
        users = (EditText) findViewById(R.id.maq1);
        see = (Button) findViewById(R.id.fun1);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    afanOneDatabaseOne = new AfanOneDatabaseOne(getApplicationContext());
                    sqLiteDatabase = afanOneDatabaseOne.getReadableDatabase();
                    Cursor cursor = afanOneDatabaseOne.ShowAfanOneResultOne(name, sqLiteDatabase);
