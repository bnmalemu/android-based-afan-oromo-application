 ...
 */
public class HerrSadiLessTwoDivision extends AppCompatActivity
{
    private EditText first, second, third;
    private Button number1, number2, result, balleessi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        first = (EditText) findViewById(R.id.div1);
        second = (EditText) findViewById(R.id.div2);
        third = (EditText) findViewById(R.id.div3);
        number1 = (Button) findViewById(R.id.div5);
        number2 = (Button) findViewById(R.id.div6);
        result = (Button) findViewById(R.id.div4);
        balleessi = (Button) findViewById(R.id.div7);
        ...
        balleessi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                first.setText("");
                second.setText("");
