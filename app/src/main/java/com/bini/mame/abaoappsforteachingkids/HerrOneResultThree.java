 ...
 */
public class HerrOneResultThree extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    HerrOneDatabaseThree herrOneDatabaseThree;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.herr_one_username_three);
        users = (EditText) findViewById(R.id.maq15);
        see = (Button) findViewById(R.id.fun15);
        listView = (ListView) findViewById(R.id.listView15);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    herrOneDatabaseThree = new HerrOneDatabaseThree(getApplicationContext());
                    sqLiteDatabase = herrOneDatabaseThree.getReadableDatabase();
                    Cursor cursor = herrOneDatabaseThree.ShowHerrResultThree(name, sqLiteDatabase );
