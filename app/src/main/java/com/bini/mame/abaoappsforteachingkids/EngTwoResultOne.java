 ...
 */
public class EngTwoResultOne extends AppCompatActivity
{
    private EditText users;
    private Button see;
    private String name;
    private String lakko, qabxii, guyyaa;
    EngTwoDatabaseOne engTwoDatabaseOne;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eng_two_username_one);
        users = (EditText) findViewById(R.id.maq7);
        see = (Button) findViewById(R.id.fun7);
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    engTwoDatabaseOne = new EngTwoDatabaseOne(getApplicationContext());
                    sqLiteDatabase = engTwoDatabaseOne.getReadableDatabase();
                    Cursor cursor = engTwoDatabaseOne.ShowEngTwoResultOne(name, sqLiteDatabase );
