 ...
 */
public class VowelEee extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vowel_ee);

        vee = (ImageView) findViewById(R.id.vowe);
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                finish();
                Intent intent = new Intent(getApplicationContext(), VowelIii.class);
