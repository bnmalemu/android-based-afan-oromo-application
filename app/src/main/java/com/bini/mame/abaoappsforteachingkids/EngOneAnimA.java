 ...
 */
public class EngOneAnimA extends AppCompatActivity
{
    ImageView bini;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bbbba);

        bini = (ImageView) findViewById(R.id.bba);
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                finish();
                startActivity(new Intent(getApplicationContext(), EngOneAnimB.class));
