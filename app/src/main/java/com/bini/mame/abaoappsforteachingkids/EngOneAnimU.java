 ...
 */
public class EngOneAnimU extends AppCompatActivity
{
    ImageView bini;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bbbbu);

        bini = (ImageView) findViewById(R.id.bbu);
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                finish();
                startActivity(new Intent(getApplicationContext(), EngOneAnimV.class));
