 ...
 */
public class CourseTwo extends TabActivity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tab1.setContent(new Intent(this, AfanOromoTwo.class));

        tab2.setIndicator("HERREGA");
        tab2.setContent(new Intent(this, HeregaTwo.class));

        tab3.setIndicator("INGILIFFA");
        tab3.setContent(new Intent(this, EnglishTwo.class));
